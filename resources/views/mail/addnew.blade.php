        ...
        <tbody>
            <tr>
                <td align="left" style="background-color: #ffffff; text-align:center;" valign="top" width="100%">
                    <center>
                        <br>
                        <img src="https://crestviewradiology.org/wp-content/uploads/2021/03/white-logo.png"
                            alt="" height="40" class="d-inline-block align-text-top">
                    </center>
                </td>
            </tr>
            <tr>
                <td align="center" class="content-padding" style="background-color: #ffffff; text-align:center;"
